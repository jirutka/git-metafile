...
struct Args {
    ...
    /// directory).
    #[argp(option, global, short = 'f', default = "Default::default()")]
    file: PathBuf,

    /// Be quite, suppress info messages.
    #[argp(switch, global, short = 'q')]
    quiet: bool,

    /// Show version and exit.
    #[argp(switch, global, short = 'V')]
    version: bool,
...
fn main() {
    ...
    let command = args.command.unwrap_or_else(|| {
        // Mimics the error message generated by argp.
        // TODO: Remove after adding support for --version into argp.
        eprintln!("One of the following subcommands must be present:\n    help\n    apply\n    save");
        exit(1)
    });
    ...
    match command {
        Command::Apply(subargs) => apply(&args.file, subargs.strict),
        Command::Save(_) => save(&args.file),
    }
}
